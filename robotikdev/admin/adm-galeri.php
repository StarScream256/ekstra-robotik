...
$galeri = query("SELECT * FROM tb_gallery");

// CARI
if( isset($_POST["cari-gl"]) ) {
  $galeri = cari_gl($_POST["keyword-gl"]);
}

// TAMBAH DATA Berita
if( isset($_POST['submit-gl'])) {

  // cek berhasil
  if( tambah_gl($_POST) > 0) {
      echo "
              <script>
...
if( isset($_POST['edit'])) {
  ...
  if( ubah_gl($_POST) > 0) {
      echo "
              ...
              document.location.href = 'adm-gallery.php';
              </script>
          ";
  } else {
      echo "
  ...
  <section class="home-section">
      ...
      <form action="" method="POST" class="search">
          ...
          <a href="" class="refresh"><i class="fas fa-sync-alt"></i></a>
            <button class="btn-search" name="cari-gl"><i class="fas fa-search"></i></button>
            <input type="text" class="input-search" placeholder="Type to Search..." name="keyword-gl" autocomplete="off">
          </div>
      </form>
      </div>
      ...
      <div class="popup" id="edit">
        <div class="popup-content">
          ...
          <div class="card-body1">
            <label>ID</label><br>
            <input type="text" class="form-control" placeholder="Masukkan ID..." name="id" id="alt" required><br>
            <label>Judul</label><br>
            <input type="text" class="form-control" placeholder="Masukkan Judul..." name="alt" id="alt" required><br>
            <label>Foto</label><br>
      ...
      <div class="popup" id="tambah">
        <div class="popup-content">
          ...
          <div class="card-body1">
            ...
            <input type="file" name="foto" id="foto" required>
            <hr/>
            <button class="btn" type="submit" name="submit-gl">Submit</button>
          </div>
        </div>
      </div>
    </form>
              ...
              <tr>
                ...
                <td>
                  <span class="action_btn">
                    ...
                    <a href="delete-galeri.php?id=<?= $row["id"]; ?>" name="hapus"><i class="bx bx-trash"></i></a>
                  </span>
                </td>
              </tr>
