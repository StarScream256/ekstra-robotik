...
// CARI
if( isset($_POST["cari-pres"]) ) {
  $prestasi = cari_pres($_POST["keyword-pres"]);
}
  ...
  <section class="home-section">
      ...
      <form action="" method="POST" class="search">
          ...
          <a href="" class="refresh"><i class="fas fa-sync-alt"></i></a>
            <button class="btn-search" name="cari-pres"><i class="fas fa-search"></i></button>
            <input type="text" class="input-search" placeholder="Type to Search..." name="keyword-pres" autocomplete="off">
          </div>
      </form>
      </div>
      ...
      <div class="popup" id="edit">
        <div class="popup-content">
          ...
          <div class="card-body1">
            ...
            <input type="text" class="form-control" placeholder="Masukkan Judul..." name="judul" id="nama" required><br>
              ...
              <?php foreach( $prestasi as $row ) : ?>
                ...
                <td>
                  <span class="action_btn">
                    ...
                    <a href="delete-prestasi.php?id=<?= $row["id"]; ?>" name="hapus"><i class="bx bx-trash"></i></a>
                  </span>
                </td>
              </tr>
